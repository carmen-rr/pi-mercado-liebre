let db ={
    ...
    producto:[
        ...
        nombre: 'Disfraz de Tiburon ', 
        descripcion: 'Disfraz de Tiburon para adultos', 
        fechaDeCarga: '01/04/2022', 
        }, 
        {
        ...
        {
        imagen:'/images/products/caballo1.jpe', 
        nombre: 'Disfraz de Caballo', 
        descripcion: 'Disfraz de Caballo para adultos', 
        fechaDeCarga: '07/03/2022', 
        },
        {
        imagen:'/images/products/banana1.jpe', 
        nombre: 'Disfraz de Banana', 
        descripcion: 'Disfraz de banana para adultos', 
        fechaDeCarga: '03/09/2022', 
        },
        {
        imagen:'/images/products/yoda1.jpe', 
        nombre: 'Disfraz de Baby Yoda', 
        descripcion: 'Disfraz de Yoda para bebes', 
        fechaDeCarga: '08/11/2022', 
        }, 
        {
        imagen:'/images/products/bob1.jpe', 
        nombre: 'Disfraz de Bob Esponja', 
        descripcion: 'Disfraz de Bob Esponja para adultos', 
        fechaDeCarga: '02/1/2022', 
        },
        {
        imagen:'/images/products/alien1.jpe', 
        nombre: 'Disfraz de Alien', 
        descripcion: 'Disfraz de Alien para adultos', 
        fechaDeCarga: '08/04/2022', 
        },
        {
        imagen:'/images/products/buzz1.jpe', 
        nombre: 'Disfraz de Buzz Light Year', 
